  ...
  <div class="login-screen">
    <div class="login-container">
      <div class="login-header">
        <img :src="logoPath" alt="CAC Santa Bárbara" class="login-logo-img">
        <h1 class="login-title">Registros Diario Call Center</h1>
        <p class="login-subtitle">CAC Santa Bárbara</p>
    ...
    <p class="login-footer">© 2026 CAC Santa Bárbara — Sistema Interno</p>
  </div>
</template>
